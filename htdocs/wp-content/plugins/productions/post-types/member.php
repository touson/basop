...
if(!class_exists('Member'))
{
    class Member
    {
        ...
        public function meta_boxes() {
            add_meta_box( 'member-image', __( 'Member Image' ), array( $this, 'member_image_meta_box' ), self::POST_TYPE);
        }
        ...
        public function meta_boxes_save( $post_id, $post ) {
            ...
            $this->process_member_meta( $post_id, $post );
        }
         ...
         */
        private function process_member_meta( $post_id, $post ) {
         ...
         */
        public function member_image_meta_box($post) {
            // Render the production details metabox
            include(sprintf("%s/../templates/%s_metabox.php", dirname(__FILE__), "member_image"));
        }
    }
}
