<div id="meta_inner">
    ...
    if ($characters) {
        ...
        foreach($characters as $character) {
            ...
            printf( '<div class="character-selector"><span>Character <input type="text" name="secondary_characters[%1$s][title]" value="%2$s" /></span><span>Cast Member : %3$s</span><span class="remove button">%4$s</span></div>', $c, $character['title'], $castSelect, 'Remove Character');
            $c++;
        }
    }
    ...
    <span class="s-add button"><?php echo 'Add Character'; ?></span>
    <script>
